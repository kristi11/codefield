...
<p>Last updated: March 25, 2018</p>

<p>Codefield ("us", "we", or "our") uses cookies on the https://codefield.io/ website (the "Service"). By using the Service, you consent to the use of cookies.</p>
...
<h2>How Codefield uses cookies</h2>
...
<li>
    <p>Preferences cookies. We may use preferences cookies to remember information that changes the way the Service behaves or looks, such as the "remember me" functionality of a registered user or a user's language preference.</p>
</li>
<li>
